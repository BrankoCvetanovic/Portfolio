...
export default function Home() {
  ...
  return (
    <div className="home">
      <h4 className={isHomeVisible ? "g-visible" : ""}>{t("greetings")}</h4>
      <h1 className={isHomeVisible ? "name n-visible" : "name"}>
        Branko Cvetanović.
      </h1>
      <h1 className={isHomeVisible ? "title t-visible" : "title"}>
        {t("home1")}
      </h1>
      <p className={isHomeVisible ? "p-visible" : ""}>
        {t("home-main")}
        <Link to={"/projects"}>{t("home-projects")}</Link>
        {t("home-main2")}
      </p>
      <div
        className={isHomeVisible ? "home-contact c-visible" : "home-contact"}
      >
        ...
        <a href="https://www.linkedin.com/in/branko-cvetanovi%C4%87-7754002b5/">
          <svg
